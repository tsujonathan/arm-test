...
namespace Microsoft.Teams.Apps.Celebration.Common.Repositories
{
    ...
    {
        /// <summary>
        /// Generates a new row key based off of the current time-stamp such that the keys are ordered most recent => oldest.
        /// </summary>
        ...
        /// <summary>
        /// Generates a new row key based off of the current time-stamp such that the keys are ordered oldest => most recent.
        /// </summary>
        /// <returns>A new row key.</returns>
