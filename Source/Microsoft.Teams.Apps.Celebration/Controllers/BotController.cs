...
namespace Microsoft.Teams.Apps.Celebration.Controllers
{
    ...
    public class BotController : ControllerBase
    {
        ...
        /// </summary>
        /// <param name="adapter">Celebration Bot Adapter instance.</param>
        /// <param name="bot">Celebration Bot instance.</param>
        public BotController(CelebrationBotAdapter adapter, IBot bot)
        {
